...
class ResultMovieDetailsModel {
  ...
  String awards;
  String poster;
  List<ResultMoviesRatingsModel> ratings;
  String metascore;
  String imdbRating;
  String imdbVotes;
  String imdbID;
  ...
  ResultMovieDetailsModel.fromJson(Map<String, dynamic> json) {
    title = json['Title'];
    year = json['Year'];
    rated = json['Rated'];
    ...
    if (json['Ratings'] != null) {
      ratings = new List<ResultMoviesRatingsModel>();
      json['Ratings'].forEach((v) {
        ratings.add(new ResultMoviesRatingsModel.fromJson(v));
      });
    }
